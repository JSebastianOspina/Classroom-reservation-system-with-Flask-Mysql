...
def protocoloCorreo(dia,hora,hola,user):
    ...
    puerto = 587
    direccionDe = "salonesmiuniversidad@gmail.com"
    contrasenaDe = "24201710112420171030"
...
app = Flask(__name__)
app.config['MYSQL_HOST'] = '172.17.92.109'
app.config['MYSQL_USER'] = 'sebas'
app.config['MYSQL_PASSWORD'] = '5AOuZUVg5A7CbIqU'
...
if(1==1): #Iniciamos el servidor
	app.run(host='172.17.92.109',port=8000,debug=True)
